"""GBQR model using MCHub + ILINet data.
...
def main(today_date: str, short_run: bool, use_local_mchub: bool, use_versioned_mchub: bool):
    """Generate GBQR forecasts using MCHub + ILINet data."""
    ...
    # Model configuration - MCHub + ILINet only
    model_config = ModelConfig(
        model_name="gbqr_ili",

        # Only ILINet supplementary source
        use_ilinet=True,
