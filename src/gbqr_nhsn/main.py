...
- NHSN hospital admissions (supplementary)
"""
...
def main(today_date: str, short_run: bool, use_local_mchub: bool, use_versioned_mchub: bool):
    """Generate GBQR forecasts using MCHub + NHSN data."""
    ...
    # Model configuration - MCHub + NHSN only
    model_config = ModelConfig(
        model_name="gbqr_nhsn",

        # Only NHSN supplementary source
        use_ilinet=False,
