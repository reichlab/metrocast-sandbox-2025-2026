"""GBQR model using MCHub data only.

This model uses:
- MCHub target data (primary and only source)
"""
...
def main(today_date: str, short_run: bool, use_local_mchub: bool, use_versioned_mchub: bool):
    """Generate GBQR forecasts using MCHub data only."""
    ...
    # Model configuration - MCHub only (no supplementary sources)
    model_config = ModelConfig(
        model_name="gbqr",

        # No supplementary sources - MCHub only
        use_ilinet=False,
